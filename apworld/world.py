...
class FungerWorld(World):
    ...
    location_name_to_id = {name: id for region in locations.LOCATIONS.values() for name, id in region.items()}
    item_name_to_id = {name: item[1] for name, item in items.ITEMS.items()}
